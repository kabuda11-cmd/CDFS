...
from data_augmentation import Crop, Mask, Reorder, Substitute, Insert, Random, CombinatorialEnumerate,SubstituteEPS,InsertEPS
...
class RecWithContrastiveLearningDataset(Dataset):
    def __init__(self, args, user_seq, test_neg_items=None, data_type='train', 
        ...
        self.augmentations = {'crop': Crop(tao=args.tao),
                              ...
                              'substituteEPS': SubstituteEPS(self.sim_path,substitute_rate=args.substitute_rate),
                              'insertEPS': InsertEPS(self.sim_path,
